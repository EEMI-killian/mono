...
class SendChallengePhoneUseCase {
    ...
    public function execute($phoneNumber): string
    {
        if($this->challengeRepository->getChallenge($phoneNumber) !== null){
            $this->challengeRepository->killChallenge($phoneNumber);
        }
        try{
            do {
        ...
        // changer l'id 
        $challenge->setChallengeId(rand(100000, 999999));
