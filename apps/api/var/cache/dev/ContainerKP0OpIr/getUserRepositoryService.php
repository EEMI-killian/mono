...
class getUserRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/User/IUserRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/User/UserRepository.php';

        return $container->privates['App\\Repository\\User\\UserRepository'] = new \App\Repository\User\UserRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
